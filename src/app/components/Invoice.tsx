export default function Invoice() {
  return (
    ...
    <article className="grid grid-cols-3 grid-rows-3 mt-8 h-32 p-6 bg-13 rounded-lg desktop:mx-80 sm:shadow-my-shadow">
      <h2 className="heading-s text-08">
        <span className="text-07 ">#</span>
        RT3080
      </h2>
      <span className="col-start-1 col-end-2 text-06 body inline-block mt-4">Due 19 Aug 2021</span>
      <strong className="col-start-1 col-end-2 text-08 heading-s mt-4">$1,800.90</strong>

      <span className="col-start-3 col-end-3 row-start-1 text-right text-07 body">Jensen Huang</span>

      <div className="col-start-3 col-end-3 row-start-2 row-end-3 flex justify-self-end justify-center items-center w-103 py-5 mt-4 bg-paid rounded-md bg-opacity-4">
        <div className="w-2 h-2 rounded-full bg-paid"></div>
